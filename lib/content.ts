...
export const editorialFinds: FindItem[] = [
  ...
  },
  {
    ...
    name: 'Кожаные лоферы',
    category: 'Обувь',
    description: 'Минималистичная пара из мягкой кожи. Проверю нужный размер в европейских бутиках.',
    price: '≈ 990 €',
    sizes: ['37', '38', '39'],
    color: 'Чёрный',
    status: 'check',
    images: ['https://images.unsplash.com/photo-1543163521-1bf539c55dd2?auto=format&fit=crop&w=1400&q=88'],
    published: true,
    sortOrder: 4,
